...
| `{{supportEmail}}` | ossama@lmkr.com | `ASSESSMENT_CONTACT_EMAIL` |
...
ossama@lmkr.com. Deleting it won't affect any application already in
progress.
...
ossama@lmkr.com and a person will get back to you.
