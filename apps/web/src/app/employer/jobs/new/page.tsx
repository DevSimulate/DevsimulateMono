  ...
  return (
    <div className="min-h-screen bg-slate-950 text-[#131722]">
      <header className="border-b border-slate-800 px-6 py-4 flex items-center gap-4">
        ...
        <span className="font-bold text-[#131722]">New Job Post</span>
      </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <select
              ...
              required
              className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2.5 text-sm text-[#131722] focus:border-cyan-500 focus:outline-none"
            >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2.5 text-sm text-[#131722] placeholder-slate-500 focus:border-cyan-500 focus:outline-none resize-none"
            />
          </div>
